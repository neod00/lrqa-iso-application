...
content = content.replace('LRQA 관리자 로그??', 'LRQA 관리자 로그인')
content = content.replace('ISO ?증?사 ?청??관??스??', 'ISO 인증심사 신청서 관리 시스템')
content = content.replace('로그??', '로그인')
...
content = content.replace('?ъ슜?먮챸', '사용자명')
content = content.replace('?밀번호', '비밀번호')
