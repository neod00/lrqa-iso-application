...
# 관리자 대시보드 부분의 깨진 한글 텍스트 수정
replacements = [
    # title 태그
    (r'<title>LRQA 愿由ъ옄 \?占쎌젙</title>', '<title>LRQA 관리자 시스템</title>'),
    
    # 관리자 헤더
    (r'<h1>LRQA 관리자 \?占쎌젙</h1>', '<h1>LRQA 관리자 시스템</h1>'),
    (r'<p>ISO \?占쎌쬆\?占쏀깭\?占쎌쬆 \?占쎌쬆\?占쏀깭\?\?관\?\?\?占쎌쬆\?\?/p>', '<p>ISO 인증심사 신청서 관리 시스템</p>'),
    ...
    (r'\?占쎌쬆\?占쏀깭\?占쎌쬆 \?占쎌쬆\?占쏀깭\?占쎌쬆', '신청서 목록'),
    (r'\?占쎌쬆\?占쏀깭\?占쎌쬆 \?占쎌쬆\?占쏀깭\?占쎌쬆', '신청서 보기'),
]
