...
class QuotationCalculator {
    ...
    init() {
        ...
        this.updateAdminModeVisibility();
        console.log('=== updateAdminModeVisibility 완료 ===');
        ...
        calculatorDiv.innerHTML = `
                ...
                <div class="quotation-draft-result" style="display: none;">
                    ...
                    <div class="draft-actions">
                        ...
                        <button type="button" class="btn btn-info btn-generate-lrqa-document admin-only" style="display: none;">
                            📋 LRQA 담당자용 정식 견적서 생성
                        </button>
                    </div>
    ...
    updateAdminModeVisibility() {
        // 전역 관리자 모드 상태 확인
        const isAdminMode = window.isAdminMode || false;
        ...
        console.log('QuotationCalculator 관리자 모드 가시성 업데이트:', isAdminMode ? '활성화' : '비활성화');
    }
}
