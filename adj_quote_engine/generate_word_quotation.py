...
"""
Word 견적서 생성 스크립트
기존 LRQA_quotation.docx 템플릿을 사용하여 test_results 폴더에 저장
"""
...
def generate_word_quotation():
    """Word 견적서 생성"""
    print("🚀 Word 견적서 생성 시작")
    print("="*50)
    ...
    # 테스트 데이터 생성 (샘플 데이터 사용)
    with open('tests/sample_payload.json', 'r', encoding='utf-8') as f:
    ...
    output_filename = f"ACME_Corporation_견적서_{timestamp}.docx"
